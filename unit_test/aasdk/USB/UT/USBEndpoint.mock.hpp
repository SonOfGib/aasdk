    ...
    namespace usb {
        namespace ut {
            ...
            public:
                ...
                MOCK_METHOD3(controlTransfer,
                             void (common::DataBuffer buffer, uint32_t timeout, Promise::Pointer promise));

                MOCK_METHOD3(bulkTransfer,
                             void (common::DataBuffer buffer, uint32_t timeout, Promise::Pointer promise));

                MOCK_METHOD3(interruptTransfer,
                             void (common::DataBuffer buffer, uint32_t timeout, Promise::Pointer promise));
